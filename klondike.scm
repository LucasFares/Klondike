...
(define (game-won)
  (and  (null? (get-cards 0))
	(null? (get-cards 1))
	(or (null? (get-cards 6)) (is-visible? (last_element (get-cards 6))))
	(or (null? (get-cards 7)) (is-visible? (last_element (get-cards 7))))
	(or (null? (get-cards 8)) (is-visible? (last_element (get-cards 8))))
	(or (null? (get-cards 9)) (is-visible? (last_element (get-cards 9))))
	(or (null? (get-cards 10)) (is-visible? (last_element (get-cards 10))))
	(or (null? (get-cards 11)) (is-visible? (last_element (get-cards 11))))
	(or (null? (get-cards 12)) (is-visible? (last_element (get-cards 12))))
))
